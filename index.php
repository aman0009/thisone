			...
			<nav class="navbar navbar-default">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<h1 style="color: orange;"><a href="index.php" style="color: orange;">FizzFlyer</span></a></h1>
					</div> 
					...
					<ul class="slides">
						<li>
							<div class="banner-w3lstext">
								<h2>Make Your Experience Better</h2>
								<p></p>
							</div>
		...
		<div class="container">  
			<div class="welcome-grids"> 
				<div class="col-md-7 welcome-w3left">
					<h4 style="font-family:cursive">OUR STORY</h4>
					<p>As college students down south, our only summer respite was weekend trips to the hill stations Ooty and Kodaikanal. These trips although refreshing, were haphazardly planned and often exceeded our budgets. This being a common problem, we came up with Fizzflyer offering student centric trips complete with budget stay and travel with the necessary impetus on the adventure.</p>  
				</div>
	...
	<div class="albums"> 
		<div class="w3lalbums-grid">
			...
			<div class="col-md-6 col-sm-6 albums-right">
				<h4>Our Latest Trips - Pondicherry</h4>
		...
		<div class="w3lalbums-grid">
			...
			<div class="col-md-6 col-sm-6 albums1-left">
				<h4>Our Latest Trips - Kodaikanal</h4>
				<p>Pondicherry (or Puducherry), a French colonial settlement in India until 1954, is now a Union Territory town bounded by the southeastern Tamil Nadu state. Its French legacy is preserved in its French Quarter, with tree-lined streets.</p>
			</div>
			<div class="clearfix"></div>
		</div>
