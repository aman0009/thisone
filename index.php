...
<link href="css/top.css" type="text/css" rel="stylesheet" media="all">  
			...
			<nav class="navbar navbar-default">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<h1 style="color: orange;"><a href="index.php" style="color: orange; font-family: 'Bad Script', cursive;">FizzFlyer</span></a></h1>
					</div> 
